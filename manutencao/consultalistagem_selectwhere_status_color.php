            ...
            <div class="mb-3">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "      <td><a href='https://www.bruno-sa.com/-github/manutencao/consultachamado_idchamado.php?emp_sigla='BMB'&id_manutencao=". $row['id_manutencao'] . "'</a>" . $row['id_manutencao'] . "</a></td>";
