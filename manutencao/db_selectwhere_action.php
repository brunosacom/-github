...
$sql = "SELECT * FROM bembos_manutencao WHERE manutencao_status='$_POST['manutencao_status']' AND manutencao_email='$_POST['manutencao_email']' ORDER BY manutencao_timestamp DESC";
