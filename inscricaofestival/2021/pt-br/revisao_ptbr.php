    ...
    <div class="container">
      ...
      <div class="row justify-content-md-center">
        ...
        <div class="col"></div>
			...
			<h1>Revisão de Inscrição - pt-br</h1>
      <div class="text-danger">Em vermelho os campos obrigatórios</div>

      </br>
      </br>
      <p class="txt_corrido"><strong>inscrição número: <?php echo $idmysql_inscricao; ?></br>
      ...
      <form action="../../php/revisaoenviarauthinsertcheck_action.php?emp_sigla='<?php echo $empresa_sigla; ?>'" method="post" name="festival_revisao" id="festival_revisao">
